...
import com.spdy.utils.ReflectHelper;
...
public class PagePlugin implements Interceptor {
	...
	public Object intercept(Invocation arg0) throws Throwable {
		...
		if(arg0.getTarget() instanceof RoutingStatementHandler){
			RoutingStatementHandler statementHandler = (RoutingStatementHandler)arg0.getTarget();
	...
	private String generatePageSql(String sql,Page page){
		if(page!=null && !StringUtils.isNullOrEmpty(dialect)){
